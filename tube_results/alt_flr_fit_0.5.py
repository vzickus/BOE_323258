...
xyuv_files = sorted(glob.glob(str('/home/vytas/1phd/paper_figures/beads_only_0.5ulmin_50um/2016-11-18 12.19.10 corr_avg 0.5ulim_FLR_sad_1.05_mask3/xyuvms2n' + '/*.txt')))
...
# Initial guess parameters. They DO matter.
V_max_g = 8
y_c_g = 26.0
z_c_g = 30.0
R_g = 26.2
...
#    plt.savefig('./flow_flr_50um_0.5ulmin_beads_only_xy_no_data_discarded_%s_percent_outside.eps' %(perc_out),format = 'eps',dpi = 1200)#, bbox_inches='tight')#, pad_inches=0.05)
...
y_intr =  find_nearest(y_eff, y_c_new)#29.50875
print "y_intr",  y_intr
...
#        plt.savefig('./flow_flr_50um_0.5ulmin_beads_only_xz_no_data_discarded_%s_percent_outside.eps' %(perc_out),format = 'eps',dpi = 1200)#, bbox_inches='tight')
#
...
#plt.savefig('./flow_flr_50um_0.5ulmin_beads_only_contour_%s_percent_outside.eps' %(perc_out),format = 'eps', dpi = 1200)